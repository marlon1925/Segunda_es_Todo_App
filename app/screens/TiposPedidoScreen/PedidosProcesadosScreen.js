...
import { TarjetaPedidosProcesados } from "../../Components/PedidosProcesados";
...
export const ListaPedidosProcesados = ({ navigation }) => {
    ...
    const recuperarProductos = async() => {
        ...
        await consultarProcesado(setPedidos);
    ...
    return <View style={styles.container}>
        ...
        <View style={styles.cajaCuerpo} >
            ...
            <TarjetaPedidosProcesados pedidos={pedidos} navegar={navigation} />
